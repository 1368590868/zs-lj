...
<script lang="ts" setup>
  ...
  import ProjectReviewCostDetailModal from './ProjectTotalCostDetailModal.vue';
  import { columns, searchFormSchema, ProjectLeaderStatus } from './ProjectTotalCostDetail.data';
  import { computed, reactive } from 'vue';
  import { useModal } from '/@/components/Modal';
  import ProjectReviewCostEditModal from './ProjectTotalCostEditModal.vue';
