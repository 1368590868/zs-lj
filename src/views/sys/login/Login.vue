...
<script lang="ts" setup>
  ...
  import { sysTenantKeyListApi } from '/@/api/tenant/manager';
  import { UNIT_LOGIN_CODE } from '/@/router/constant';
  import { detailSettingApi } from '/@/api/sys/systemConfig';
  ...
  const getUnitCode = async () => {
    ...
    const res = await sysTenantKeyListApi(localStorage.getItem(UNIT_LOGIN_CODE));
    if (res) {
      const { id } = res;
      modelKey.value = id;
